...
import com.example.uberclone.activities.driver.NotificationBooking;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
        ...
        if(title != null){
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                ...
                if(title.contains("SOLICITUD DE SERVICIO")){
                    ...
                    String mins = data.get("min");
                    String distance = data.get("distance");
                    showNotificationApiOreoActions(title,body,idClient);
                    showNotificationActivity(idClient,origin,destination,mins,distance);
    ...
    private void showNotificationActivity(String idClient, String origin, String destination, String mins, String distance) {
        ...
        if(!isScreenOn){
            ...
            Intent intent = new Intent(getBaseContext(), NotificationBooking.class);
