...
public class HistoryBookingClientAdapter extends FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingClientAdapter.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull final HistoryBookingClientAdapter.ViewHolder holder, int position, @NonNull HistoryBooking historyBooking) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, HistoryBookingDetailClient.class);
    ...
    @NonNull
    @Override
    public HistoryBookingClientAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_history_booking,parent,false);

        return new HistoryBookingClientAdapter.ViewHolder(view);
    }
